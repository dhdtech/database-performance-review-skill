...
```bash
curl -sSL https://raw.githubusercontent.com/dhdtech/dba-review-skill/main/install.sh | bash
```
...
```bash
git clone https://github.com/dhdtech/dba-review-skill.git \
...
> If you have `gh` 2.74+, you can also run: `gh skill install dhdtech/dba-review-skill`
...
<p align="center">
  ...
  <a href="https://github.com/dhdtech/dba-review-skill/issues">Open an issue</a>.
